...
function filterByQuery(query, animalsArray) {
    ...
    if (query.personalityTraits) {
        ...
        // If presonalityTraits is a string, place it into a new array and save
        ...
        personalityTraitsArray.forEach(trait => {
            ...
            // so at the end we'll have na array of animals that have every one
            // of the traits wheen the .forEach() loop is finished.
...
app.post('/api/animals', (req, res) => {
    ...
    // if any data in req.body is incorrect, send 400 back
